...
public abstract class AbstractCompraId  implements java.io.Serializable {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof AbstractCompraId) ) return false;
 ...
 && ( (this.getFecCompra()==castOther.getFecCompra()) || ( this.getFecCompra()!=null && castOther.getFecCompra()!=null && this.getFecCompra().equals(castOther.getFecCompra()) ) );
   }
   ...
   public int hashCode() {
         ...
         result = 37 * result + ( getFecCompra() == null ? 0 : this.getFecCompra().hashCode() );
         return result;
   }   
