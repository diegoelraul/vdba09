...
public abstract class AbstractPelicula  implements java.io.Serializable {
	...
	/** minimal constructor */
    public AbstractPelicula(String titulo) {
        this.titulo = titulo;
    }
    
    /** full constructor */
    public AbstractPelicula(String titulo, String nombreDirector, String apellidosDirector, String idioma, double coste, double precio, Integer disponibilidad, String pathImagen) {
        this.titulo = titulo;
